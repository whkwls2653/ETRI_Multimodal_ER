...
def main(args):
    ...
    with torch.no_grad():
        ...
        if test:
            with open('./labels_preds_cogmen.txt', 'w') as f:
                f.write(str(golds) + '\n')
                f.write(str(preds))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir", type=str, help="Dataset directory path", default="./data"
    )
    parser.add_argument(
        "--pt_dir", type=str, help="Dataset directory path", default="./data"
    )
