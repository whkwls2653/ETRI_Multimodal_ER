...
def get_iemocap():
    ...
    if args.dataset == "iemocap":
      ...
      (
            ...
            open(args.feat_dir, "rb"), encoding="latin1"
        )[:9]
    train, dev, test = [], [], []
...
def main(args):
    if args.dataset == "KEMDy19":
        train, dev, test = get_iemocap()
        data = {"train": train, "dev": dev, "test": test}
        cogmen.utils.save_pkl(data, args.res_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        choices=["iemocap", "iemocap_4", "mosei","KEMDy19"],
        default='KEMDy19',
        help="Dataset name.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--feat_dir", type=str, default="./data", help="Dataset directory"
    )
    parser.add_argument(
        "--res_dir", type=str, default="./data", help="Dataset directory"
    )
    parser.add_argument(
